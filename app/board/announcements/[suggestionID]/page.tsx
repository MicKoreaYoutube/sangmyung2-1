            ...
            <Card className={`animate__animated ${inView ? classToAdd : "invisible"}`} ref={ref}>
              ...
              <CardHeader>
                ...
                <CardDescription className="font-SUITE-Regular flex flex-row text-md md:text-xl">
                  ...
                  <div className="mx-auto flex flex-row data-[status=미반영]:text-[#CCCCCC] [&[data-status=미반영]>div.mark-circle]:bg-[#CCCCCC] data-[status=처리중]:text-[#F5A623] [&[data-status=처리중]>div.mark-circle]:bg-[#F5A623] data-[status=반영됨]:text-[#50E3C2] [&[data-status=반영됨]>div.mark-circle]:bg-[#50E3C2] data-[status=반려됨]:text-[#F00] [&[data-status=반려됨]>div.mark-circle]:bg-[#F00] data-[status=보류됨]:text-[#6B8E23] [&[data-status=보류됨]>div.mark-circle]:bg-[#6B8E23]" data-status={suggestion?.status}>
              ...
              <CardContent className="font-SUITE-Regular space-y-3">
                ...
                <p className="text-lg font-SUITE-Regular whitespace-pre-wrap">{suggestion?.content}</p>
              </CardContent>
